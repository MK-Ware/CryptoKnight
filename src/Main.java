        		...
        		EncryptThread = new Thread()
        		{
                    ...
                    public void run()
        			{
        				...
        				try
        				{
        					if (Hash.isSelected())
        					{
        						CT = TextEncrypt.CBCEncrypt(InputText.getText(), Pwd.getText(), Integer.parseInt(BSOptions.getSelectedItem().toString().substring(0, BSOptions.getSelectedItem().toString().lastIndexOf("b") - 1)), AlgOptions.getSelectedItem().toString(), "Q");
        					}
        					
        					else
        					{
        						CT = TextEncrypt.CBCEncrypt(InputText.getText(), Pwd.getText(), Integer.parseInt(BSOptions.getSelectedItem().toString().substring(0, BSOptions.getSelectedItem().toString().lastIndexOf("b") - 1)), AlgOptions.getSelectedItem().toString(), "S");
        					}
        				}
        		...
        		DecryptThread = new Thread()
        		{
                    ...
                    public void run()
        			{
        				...
        				try
        				{
        					if (Hash.isSelected())
        					{
        						CT = TextEncrypt.CBCDecrypt(InputText.getText(), Pwd.getText(), Integer.parseInt(BSOptions.getSelectedItem().toString().substring(0, BSOptions.getSelectedItem().toString().lastIndexOf("b") - 1)), AlgOptions.getSelectedItem().toString(), "Q");
        					}
        					
        					else
        					{
        						CT = TextEncrypt.CBCDecrypt(InputText.getText(), Pwd.getText(), Integer.parseInt(BSOptions.getSelectedItem().toString().substring(0, BSOptions.getSelectedItem().toString().lastIndexOf("b") - 1)), AlgOptions.getSelectedItem().toString(), "S");
        					}
        				}
        		...
        		FEncryptThread = new Thread()
        		{
                    ...
                    public void run()
        			{
        				...
        				if (wipe.isSelected())
        				{
        					...
        					{
        						JOptionPane.showMessageDialog(Main.this, "An encrypted file with the same name already exists!\nRename or move it to avoid losing your data!", "Warning!", JOptionPane.WARNING_MESSAGE);
        					}
        					...
        					else
        					{
        						try 
            					{
        							try
        	        				{
        	        					if (FMode.isSelected())
        	        					{
        	        						OpRes = FileEncrypt.CBCEncrypt(FAlgOptions.getSelectedItem().toString(),Integer.parseInt(FBSOptions.getSelectedItem().toString().substring(0, FBSOptions.getSelectedItem().toString().lastIndexOf("b") - 1)), InputFile.getText(), FPwd.getText(), "Q");
        	        					}
        	        					
        	        					else
        	        					{
        	        						OpRes= FileEncrypt.CBCEncrypt(FAlgOptions.getSelectedItem().toString(),Integer.parseInt(FBSOptions.getSelectedItem().toString().substring(0, FBSOptions.getSelectedItem().toString().lastIndexOf("b") - 1)), InputFile.getText(), FPwd.getText(), "S");
        	        					}
        	        				}
            						...
            						JOptionPane.showMessageDialog(Main.this, "Input file wiped successfully", "Success!", JOptionPane.INFORMATION_MESSAGE);
    							}
            					catch (FileNotFoundException e)
            					{
            						JOptionPane.showMessageDialog(Main.this, "Could not find the input file", "Error", JOptionPane.ERROR_MESSAGE);
    							}
            					catch (IOException e)
            					{
            						JOptionPane.showMessageDialog(Main.this, "Could not find or access the input file", "Error", JOptionPane.ERROR_MESSAGE);
    							}
        					}
        		...
        		FDecryptThread = new Thread()
        		{
                    ...
                    public void run()
        			{
        				...
        				try
        				{
        					if (FMode.isSelected())
        					{
        						OpRes = FileEncrypt.CBCDecrypt(FAlgOptions.getSelectedItem().toString(),Integer.parseInt(FBSOptions.getSelectedItem().toString().substring(0, FBSOptions.getSelectedItem().toString().lastIndexOf("b") - 1)),InputFile.getText() , FPwd.getText(), "Q");
        					}
        					
        					else
        					{
        						OpRes = FileEncrypt.CBCDecrypt(FAlgOptions.getSelectedItem().toString(),Integer.parseInt(FBSOptions.getSelectedItem().toString().substring(0, FBSOptions.getSelectedItem().toString().lastIndexOf("b") - 1)),InputFile.getText() , FPwd.getText(), "S");
        					}
        				}
        	...
        	else if (e.getSource() == DoHash)
        	{
        		DHThread = new Thread()
        		{
                    ...
                    public void run()
        			{
        				...
        				try
        				{
        					if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("MD2"))
            				{
            					HRes = HashFactory.md2Hash(p);
            				}
        					
        					else if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("MD5"))
            				{
        						HRes = HashFactory.md5Hash(p);
            				}
        					
        					else if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("SHA1"))
            				{
        						HRes = HashFactory.SHA1Hash(p);
            				}
        					
        					else if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("SHA-224"))
            				{
        						HRes = HashFactory.SHA224Hash(p);
            				}
        					
        					else if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("SHA-256"))
            				{
        						HRes = HashFactory.SHA256Hash(p);
            				}
        					
        					else if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("SHA-384"))
            				{
        						HRes = HashFactory.SHA384Hash(p);
            				}
        					
        					else if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("SHA-512"))
            				{
        						HRes = HashFactory.SHA512Hash(p);
            				}
        					
        					else if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("bcrypt"))
            				{
        						HRes = HashFactory.BCryptHash(p, (Integer) bcCost.getValue());
            				}
        					
        					else if (HAlgOptions.getSelectedItem().toString().equalsIgnoreCase("scrypt"))
            				{
        	...
        	else if (e.getSource() == BPGen)
        	{
        		BPThread = new Thread()
        		{
                    ...
                    public void run()
        			{
        				...
        				{
        					JOptionPane.showMessageDialog(Main.this, "Passwords that are below 8 characters in length are weak!", "Warning!", JOptionPane.WARNING_MESSAGE);
        				}
